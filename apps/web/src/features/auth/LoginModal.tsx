        ...
        <>
          ...
          >
            <div className="relative w-full max-w-md glass-elevated p-8" onKeyDown={(e) => { if (e.key === 'Escape') onClose(); }}>
              <h2 id="login-title" className="text-lg font-semibold mb-4">Log in</h2>
              <form className="space-y-3" onSubmit={handleSubmit(onSubmit)}>
                <div>
                  <label className="block text-sm text-neutral-300 mb-1" htmlFor="email">Email</label>
                  <input id="email" autoFocus {...register('email')} className="w-full bg-neutral-800/60 border border-white/10 rounded-md px-3 py-2 outline-none focus:ring-2 focus:ring-brand-500" placeholder="you@example.com" />
