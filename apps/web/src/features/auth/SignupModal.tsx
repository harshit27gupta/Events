      ...
      <div className="relative w-full max-w-md glass p-6">
        ...
        <form className="space-y-3" onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            <input {...register('name')} className="w-full bg-neutral-800/60 border border-white/10 rounded-md px-3 py-2 outline-none focus:ring-2 focus:ring-brand-500" placeholder="Your name" />
